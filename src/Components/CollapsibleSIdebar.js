      ...
      <>
        <div className="main-container">
          ...
          >
            ...
            {isOpen && <Typography style={{color: "#6B7280", fontSize: "14px", marginLeft: "16px", marginTop: "24px"}}>General</Typography>}
            <section className="routes">
              {generalRoutes.map((route, index) => <SidebarItem key={index} route={route} isOpen={isOpen} setIsOpen={setIsOpen} showAnimation={showAnimation} />)}
            </section>

            {isOpen && <Typography style={{color: "#6B7280", fontSize: "14px", marginLeft: "16px", marginTop: "24px"}}>Products</Typography>}
            <section className="routes">
              {productRoutes.map((route, index) => <SidebarItem key={index} route={route} isOpen={isOpen} setIsOpen={setIsOpen} showAnimation={showAnimation} />)}
            </section>

            {isOpen && <Typography style={{color: "#6B7280", fontSize: "14px", marginLeft: "16px", marginTop: "24px"}}>Settings</Typography>}
            <section className="routes">
              {settingsRoutes.map((route, index) => <SidebarItem key={index} route={route} isOpen={isOpen} setIsOpen={setIsOpen} showAnimation={showAnimation} />)}
            </section>
