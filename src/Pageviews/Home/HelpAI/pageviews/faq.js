import { Add, Close, Delete, Download, MoreVert, Upload } from "@mui/icons-material";
import { Button, Container, FormControl, Grid, IconButton, Menu, MenuItem, Modal, TextField, Typography } from "@mui/material";
...
const FAQ = () => {
    ...
    function displayFAQ () {
        ...
        if (faq.length === 0)
            return <Container style={{ width: "100%", display: "flex", justifyContent: "center", padding: "25px", backgroundColor: "white" }}>
            ...
            <Modal open={modalOpen}>
                ...
                <Container className={classes.addUserContainer}>
                    ...
                    <div style={{ width :"100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <Typography style={{ fontSize: "24px", fontWeight: "700", }}>Create New FAQ</Typography>
                ...
                <div className={classes.topHolder}>
                        <div>
                            ...
                            <div style={{display: "flex"}}> 
                                ...
                                <div style={{color: "#24459c"}} className={classes.subtitle}>FAQ</div>
                            </div>
                        </div>

                        <div className={classes.buttonHolder}>
                            <Button style={{backgroundColor: "#24459c", color: "white"}} onClick={()=>{setModalOpen(true);}}>Create New FAQ</Button>
                        </div>
    ...
    return <>
        ...
        <Modal open={editOpen}>
            ...
            <Container className={classes.addUserContainer}>
                ...
                <div style={{ width :"100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography style={{ fontSize: "24px", fontWeight: "700", }}>Edit FAQ</Typography>
                ...
                <div>
                    ...
                    <FormControl fullWidth>
                        <TextField
                            ...
                            label="FAQ Type"
                            size="small"
                            onChange={(e)=>{setEditFaq({ ...editFaq, type: e.target.value })}}
                        >
                            <MenuItem value="App">App</MenuItem>
                            <MenuItem value="Service">Service</MenuItem>
                            <MenuItem value="Security">Security</MenuItem>
        ...
        <Grid item xs={6} sm={4} md={3} lg={3}>
            <Container className={classes.packageContainer}>
                ...
                <div className={classes.spacerSmall} />
                <div style={{color: "#090A0A", fontSize: "16px", fontWeight: "600", textAlign: "center"}}>{props.faq.title}</div>
                <div className={classes.spacerSmall} />
                <div style={{color: "#585858", fontSize: "12px", fontWeight: "400", textAlign: "center"}}>{props.faq.type}</div>
                <div className={classes.spacerSmall} />
                <div style={{color: "#090A0A", fontSize: "14px", fontWeight: "500", textAlign: "center"}}>{props.faq.answer}</div>
                <div className={classes.spacerSmall} />
