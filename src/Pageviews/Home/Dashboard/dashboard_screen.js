...
const DashboardScreen = () => {
    ...
    return (
        <div className={classes.holder}>
                ...
                <div>
                    ...
                    <div style={{ display: "flex", gap: '720px', alignItems: 'center' }}>
                        <div style={{ display: "flex" }}>
                            <div style={{ color: "black" }} className={classes.subtitle}>Good Afternoon, / </div>
                            <div style={{ color: "#24459c" }} className={classes.subtitle}> userName</div>
                        </div>
                        ...
                        <div style={{ display: "flex", gap: '10px', alignItems: 'center' }}>
                            ...
                            <div>
                                <FormControl sx={{ m: 1, minWidth: 220, backgroundColor: 'white', borderRadius: '10px' }} size="small">
                                    <InputLabel id="demo-select-small-label">All Departments</InputLabel>
                                    <Select
                                        labelId="demo-select-small-label"
                                        id="demo-select-small"
                                        value={departments}
            ...
            <Box sx={{ backgroundColor: 'white', paddingInline: '25px', paddingBottom: '50px',paddingTop: '20px' }}>
                <Box sx={{ display: "flex", justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px',flexWrap: 'wrap' }}>
                    <p style={{ color: '#000000', fontSize: '24px', fontWeight: '400' }}>Overview</p>
                    <div style={{ display: "flex", gap: '10px', alignItems: 'center' }}>
                        <div>
                            <FormControl sx={{ m: 1, minWidth: 220, backgroundColor: 'white', borderRadius: '10px' }} size="small">
                        ...
                        <div>
                            <FormControl sx={{ m: 1, minWidth: 220, backgroundColor: '#24459C', borderRadius: '10px' }} size="small">
                                <InputLabel id="demo-select-small-label" sx={{ color: 'white' }}>Add Item</InputLabel>
                                <Select
                                    labelId="demo-select-small-label"
                                    id="demo-select-small"
                                    value={items}
            ...
            <Box sx={{ marginBlock: '20px',backgroundColor: 'white', paddingInline: '25px', paddingBottom: '50px',paddingTop: '20px'  }}>
            <Box sx={{ display: "flex", justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px',flexWrap: 'wrap' }}>
                    <p style={{ color: '#000000', fontSize: '24px', fontWeight: '400' }}>Comparison</p>
                    <div style={{ display: "flex", gap: '10px', alignItems: 'center' }}>
                        <div>
                            <FormControl sx={{ m: 1, minWidth: 180, backgroundColor: 'white', borderRadius: '10px' }} size="small">
