...
const ControlPanelCustomerScreen = () => {
    ...
    const [newNotConnectedMachineType, setNewNonConnectedMachineType] = useState("");
    ...
    const addNewWashingMachinne = () => {
        ...
        fetch('https://api.showaapp.com/admin/control-panel/add-new-washing-machine-type', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const addNewNonConnectedMachinetype = () => {
        ...
        fetch('https://api.showaapp.com/admin/control-panel/add-new-not-connected-machine-type', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
                ...
                <div className={classes.tableHolder}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={3} sm={3} md={3} lg={3}>
                            ...
                            <div className={classes.optionTitle}>Non Connected Machine Type</div>
                            <div className={classes.optionSubtitle}>User Input Non Connected Machine Type</div>
                        ...
                        <Grid item xs={8} sm={8} md={8} lg={8}>
                            ...
                            <FormControl fullWidth>
                                ...
                                >
                                    {
                                        nonConnectedMachineType.length != 0 ? nonConnectedMachineType.map((nonConnectedMachine) =>
                                            <MenuItem value={nonConnectedMachine}>{nonConnectedMachine}</MenuItem>
                                        ) : <MenuItem value="no non connected machine">Non Connected Machine Type</MenuItem>
                                    }
                        ...
                        <Grid item xs={1} sm={1} md={1} lg={1}>
                            ...
                            <IconButton onClick={()=>{setNonConnectedMachineTypeOpen(true);}}>
                                <AddCircleOutline />
                            </IconButton>
