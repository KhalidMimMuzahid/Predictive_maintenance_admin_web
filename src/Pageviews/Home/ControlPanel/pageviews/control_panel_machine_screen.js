...
const ControlPanelMachine = () => {
  ...
  const addNewModel = () => {
    ...
    fetch(
      "https://api.showaapp.com/admin/control-panel/add-model/" + currentBrand,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const addNewIssue = () => {
    ...
    fetch(
      "https://api.showaapp.com/admin/control-panel/add-issue/" +
        currentBrand +
        "/" +
        currentModel,
      {
          ...
          {currentBrand !== "" ? (
            <Grid container spacing={2}>
              <Grid item xs={3} sm={3} md={3} lg={3}>
                ...
                <div className={classes.optionSubtitle}>
                  User Inputs Washing Machine Model Number
                </div>
              </Grid>
