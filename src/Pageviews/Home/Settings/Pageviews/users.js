...
const AdminComponent = (props) => {
    ...
    function formatDate(date) {
        ...
        var requiredDateString = dateString + "-" + monthString + "-" + yearString + " at " + hourString + ":" + minuteString;
        ...
        <Grid item xs={6} sm={4} md={3} lg={2}>
            <div className={classes.adminComponent}>
                <div className={classes.adminProfileImageHolder}>
                    <img src={props.admin.adminImageAddress} alt="Admin Profile Image" className={classes.adminImg} />
                </div>
                ...
                <div className={classes.spacerSmall} />
                <div style={{fontSize: "10px", color: "#5A6872", fontWeight: "400", textAlign: "center"}}>
                    Created At
                </div>
                <div style={{fontSize: "12px", color: "#5A6872", fontWeight: "600", textAlign: "center"}}>
