import { Add, Category, Dehaze, Download, MoreVert, Person } from "@mui/icons-material";
import { Button, Divider, IconButton, Menu, MenuItem, Modal } from "@mui/material";
...
const IotScreen = () => {
    ...
    return (
        <div>
            ...
            <Modal open={addProductModalOpen}>
            ...
            <div className={classes.holder}>
                ...
                <div className={classes.topHolder}>
                    ...
                    <div className={classes.buttonHolder}>
                        ...
                        <div className={classes.spacerSmall} />
                        <Button style={{backgroundColor: "#24459c", color: "white"}}>Add Product</Button>
                    </div>
