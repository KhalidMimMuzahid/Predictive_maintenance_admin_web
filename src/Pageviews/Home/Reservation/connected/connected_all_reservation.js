...
import { Close, Delete, Equalizer, Group, Money, MoreVert, Person, Stop } from "@mui/icons-material";
import { Box, Container, IconButton, Menu, MenuItem, Modal, Snackbar, Tab, Tabs, Typography } from "@mui/material";
...
class AllReservationTable extends Component {
    ...
    addNewItem = (reservation, index) => {
        ...
        allReservationRows.push({ id: index, customer_name: reservation.uid, reservation_id: reservation._id, status: reservation.status, schedule: reservation.reservationSchedule, service_type: reservation.washingMachineId, location: reservation.washingMachineId, invoice: reservation, issues: reservation, bidStatus: reservation.bidStatus, assign: reservation, action: reservation});
    ...
    addReservationGroup (gid) {
        ...
        axios.post('https://api.showaapp.com/admin/reservation/create-reservation-group', { reservations: reservations, groupId: gid })
            .then(response => {
...
const BidStatusComponent = (props) => {
    ...
    return <div className={props.value == "Ongoing" ? classes.ongoingBidContainer : props.value == "Closed" ? classes.closedBidContainer : classes.spacerSmall}>
        {props.value}
    </div>
...
const ActionComponent = (props) => {
    ...
    function sendForBidding () {
        fetch('https://api.showaapp.com/admin/reservation/send-for-bidding/' + props.value._id, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function closeBidding () {
        fetch('https://api.showaapp.com/admin/reservation/close-bidding/' + props.value._id, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
...
const VendorGroupActionComponent = (props) => {
    ...
    function assignVendor () {
        fetch('https://api.showaapp.com/admin/reservation/assign-vendor-to-group/' + props.value.group.groupId + "/" + props.value.vendor.uid, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
...
const GroupBidStatusComponent = (props) => {
    ...
    return <div className={props == "Ongoing" ? classes.ongoingBidContainer : props == "Closed" ? classes.closedBidContainer : classes.spacerSmall}>
        {props}
    </div>
...
const GroupAssignVendorComponent = (props) => {
    ...
    function getServiceProviderWithId() {
        fetch('https://api.showaapp.com/admin/service-provider/get-service-provider-with-id/' + props.assignedVendorId, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
...
const GroupActionComponent = (props) => {
    ...
    function deleteGroup () {
        fetch('https://api.showaapp.com/admin/reservation/delete-group/' + props.groupId, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function sendForBidding () {
        fetch('https://api.showaapp.com/admin/reservation/send-group-for-bidding/' + props.groupId, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function closeBidding () {
        fetch('https://api.showaapp.com/admin/reservation/close-bidding-for-group/' + props.groupId, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
...
const GroupStatusComponent = (props) => {
    ...
    return <div className={props == "Pending" ? classes.pendingContainer : props == "Ongoing" ? classes.ongoingContainer : props == "Accepted" ? classes.acceptedContainer : props == "Canceled" ? classes.cenceledContainer : props == "Completed" ? classes.completedContainer : classes.pendingContainer}>
        {props}
    </div>
}
...
class AllGroupTable extends Component {
    ...
    async getAllConnectedResrvtaionGroups() {
        await fetch('https://api.showaapp.com/admin/reservation/get-all-connected-reservation-groups', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    addNewItem = (group, index) => {
        ...
        allReservationGroups.push({ id: index, groupId: group.groupId, status: group.status, assign: group, bidStatus: group.bidStatus, action: group});
...
const ExpandableGroupColumns = [
    ...
    },
    {
        ...
        cell: row => ExpandedIssuesComponent({problems: row.problems, imageAddresses: row.imageAddresses}),
    },
];
